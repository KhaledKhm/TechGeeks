...
function cloe_brooks_sc_resize_actions(){"use strict";cloe_brooks_sc_sliders_resize()}
...
if(rez.error===''){jQuery(table).find('.sc_table').remove();jQuery(table).find('script').after(rez.data);jQuery(table).data('sort',sort);cloe_brooks_select_players_category(jQuery(table).find('.sc_players_table_category select'))}});e.preventDefault();return!1})}
