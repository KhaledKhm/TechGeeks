...
UserRepository urepo;
	@Override
	public Appointment addAppointement(Appointment a,int iduser,String username) {
		// TODO Auto-generated method stub
		User u = urepo.findById(iduser).orElse(null);
		User user = urepo.findByfirstName((String)username);
		a.setWomen(u);
		a.setExpert(user);
	...
	@Override
	public Appointment updateAppointment(Appointment a,int id ) {
		// TODO Auto-generated method stub
		Appointment app=apprepo.findById(id).orElse(null);
		app.setDate(a.getDate());
		app.setLocal(a.getLocal());
		return apprepo.save(a);
	}
	@Override
