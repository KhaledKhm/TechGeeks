...
public class AppointmentController {
	...
	@PostMapping("/add-Appointment/{iduser}/{username}")
	@ResponseBody
	Appointment addAppointment(@RequestBody Appointment a,@PathVariable("iduser")int iduser,@PathVariable("username")String username){//@request taayet lel les attributs
	return as.addAppointement(a, iduser, username);
	}
	...
	@ResponseBody
	Appointment updateAppointment(@RequestBody Appointment a,@PathVariable("id")int id){
		return as.updateAppointment(a,id);
	}
